...
export const DB_URL = _.defaultTo(process.env.DB_URL, "secret");
export const NODE_ENV = _.defaultTo(process.env.NODE_ENV, "development");
...
export const DB = {
  ...
  DB_URL: _.defaultTo(process.env.DB_URL, "localhost"),
